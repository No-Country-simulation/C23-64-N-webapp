...
import { Box, Button, Flex, Heading, Table, Tbody, Td, Th, Thead, Tr, useDisclosure, VStack, } from "@chakra-ui/react";
  ...
  return (
    <VStack justifyContent={"center"}>
      <Flex w='100%'>
              ...
              <Tbody>
                {rentals.map((reserva) => (
                  <Tr key={reserva.id}>
                    ...
                    <Td>{dateFormat.format(new Date(reserva.rentalDate))}</Td>
                    <Td textAlign="right">{formatPrice(reserva.total)}</Td>
                  </Tr>
                ))}
              </Tbody>
            </Table>
        ...
        <ModalReservations isOpen={isReservationOpen} onClose={onReservationClose} addReservation={addReservation}
                           products={furniture}/>

        {/* MODAL PARA EDITAR PRODUCTO */}
        <ModalEditProduct isOpen={isEditOpen} onClose={onEditClose} product={selectedProduct}
